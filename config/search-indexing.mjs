...
export const BASE_INDEXABLE_PAGE_ROUTES = Object.freeze([
    ...
    freezeRoute({ pathname: "/engine", assetPath: "apps/features/engine.html" }),
    freezeRoute({ pathname: "/academy", assetPath: "apps/features/academy.html" }),
    freezeRoute({ pathname: "/lessons", assetPath: "apps/features/lessons.html" }),
    freezeRoute({ pathname: "/puzzles", assetPath: "apps/features/puzzles.html" }),
    freezeRoute({ pathname: "/repertoire", assetPath: "apps/features/repertoire.html" }),
