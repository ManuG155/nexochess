...
const escapeCheckMoves: MovePractice[] = [
    { id: "escape-bogo-bishop", kind: "move", fen: "rnbqk2r/pppp1ppp/4pn2/8/1bPP4/5N2/PP2PPPP/RNBQKB1R w KQkq - 0 1", prompt: "findMove", expected: { from: "c1", to: "d2" }, accepted: [{ from: "b1", to: "c3" }, { from: "b1", to: "d2" }] },
    { id: "escape-moscow-bishop", kind: "move", fen: "rnbqkbnr/pp2pppp/3p4/1Bp5/4P3/5N2/PPPP1PPP/RNBQK2R b KQkq - 0 1", prompt: "findMove", expected: { from: "c8", to: "d7" }, accepted: [{ from: "b8", to: "c6" }] },
    { id: "escape-budapest-bishop", kind: "move", fen: "rnbqk2r/pppp1ppp/8/4P3/1bP2Bn1/8/PP2PPPP/RN1QKBNR w KQkq - 0 1", prompt: "findMove", expected: { from: "b1", to: "c3" }, accepted: [{ from: "b1", to: "d2" }, { from: "d1", to: "d2" }] },
    { id: "escape-queen-a4", kind: "move", fen: "rnbqkb1r/ppp2ppp/4pn2/3p4/Q1PP4/2N5/PP2PPPP/R1B1KBNR b KQkq - 0 1", prompt: "findMove", expected: { from: "c8", to: "d7" }, accepted: [{ from: "b8", to: "c6" }, { from: "c7", to: "c6" }, { from: "d8", to: "d7" }] },
    { id: "escape-castled-bishop", kind: "move", fen: "r1bq1rk1/ppppbBpp/2n2n2/4p3/4P3/3P1N2/PPP2PPP/RNBQ1RK1 b - - 0 1", prompt: "findMove", expected: { from: "f8", to: "f7" } },
    { id: "escape-castled-knight", kind: "move", fen: "r2q1rk1/ppp2ppp/2np1N2/2b1p1B1/2BnP1b1/3P1N2/PPP2PPP/R2Q1RK1 b - - 0 1", prompt: "findMove", expected: { from: "g7", to: "f6" } },
    { id: "escape-centre-knight", kind: "move", fen: "r2qkbnr/ppp2ppp/3p4/3Pp3/2B1P1b1/4Bn2/PPP2PPP/RN1QK2R w KQkq - 0 1", prompt: "findMove", expected: { from: "g2", to: "f3" } }
];

const enPassantMoves: MovePractice[] = [
    { id: "ep-e5-d6-game", kind: "move", fen: "rnbqkbnr/1pp1pppp/p7/3pP3/8/8/PPPP1PPP/RNBQKBNR w KQkq d6 0 3", prompt: "findMove", expected: { from: "e5", to: "d6" } },
    { id: "ep-c5-b6-game", kind: "move", fen: "rnbqkbnr/p1pppppp/8/1pP5/8/8/PP1PPPPP/RNBQKBNR w KQkq b6 0 2", prompt: "findMove", expected: { from: "c5", to: "b6" } },
    { id: "ep-f5-g6-game", kind: "move", fen: "rnbqkbnr/pppppp1p/8/5Pp1/8/8/PPPPP1PP/RNBQKBNR w KQkq g6 0 2", prompt: "findMove", expected: { from: "f5", to: "g6" } },
    { id: "ep-e4-f3-game", kind: "move", fen: "rnbqkbnr/pppp1ppp/8/3P4/4pP2/8/PPP1P1PP/RNBQKBNR b KQkq f3 0 3", prompt: "findMove", expected: { from: "e4", to: "f3" } },
    { id: "ep-d4-c3-game", kind: "move", fen: "rnbqkbnr/ppp1pppp/8/8/2Pp4/8/PP1PPPPP/RNBQKBNR b KQkq c3 0 2", prompt: "findMove", expected: { from: "d4", to: "c3" } }
];
...
const ENDGAME_CHECKPOINT_MARKERS = ["ready.opposition", "ready.king-rook-mate", "ready.outside-passer"];
const FILES = "abcdefgh";
const ALL_SQUARES: Square[] = Array.from({ length: 64 }, (_, index) => `${FILES[index % 8]}${Math.floor(index / 8) + 1}` as Square);

type ContextPiece = { square: Square; type: "p" | "n" | "b" | "r" | "q"; color: "w" | "b"; };
const CONTEXT_PIECES: ContextPiece[] = [
    { square: "a2", type: "p", color: "w" }, { square: "a7", type: "p", color: "b" },
    { square: "h2", type: "p", color: "w" }, { square: "h7", type: "p", color: "b" },
    { square: "b2", type: "p", color: "w" }, { square: "b7", type: "p", color: "b" },
    { square: "g2", type: "p", color: "w" }, { square: "g7", type: "p", color: "b" },
    { square: "c2", type: "p", color: "w" }, { square: "c7", type: "p", color: "b" },
    { square: "f2", type: "p", color: "w" }, { square: "f7", type: "p", color: "b" },
    { square: "d3", type: "p", color: "w" }, { square: "d6", type: "p", color: "b" },
    { square: "e3", type: "p", color: "w" }, { square: "e6", type: "p", color: "b" },
    { square: "c3", type: "n", color: "w" }, { square: "c6", type: "n", color: "b" },
    { square: "f3", type: "n", color: "w" }, { square: "f6", type: "n", color: "b" },
    { square: "c4", type: "b", color: "w" }, { square: "c5", type: "b", color: "b" },
    { square: "f4", type: "b", color: "w" }, { square: "f5", type: "b", color: "b" },
    { square: "a1", type: "r", color: "w" }, { square: "a8", type: "r", color: "b" },
    { square: "h1", type: "r", color: "w" }, { square: "h8", type: "r", color: "b" },
    { square: "d1", type: "q", color: "w" }, { square: "d8", type: "q", color: "b" },
    { square: "e2", type: "p", color: "w" }, { square: "e7", type: "p", color: "b" },
    { square: "b1", type: "n", color: "w" }, { square: "b8", type: "n", color: "b" },
    { square: "g1", type: "n", color: "w" }, { square: "g8", type: "n", color: "b" },
    { square: "b3", type: "p", color: "w" }, { square: "b6", type: "p", color: "b" },
    { square: "g3", type: "p", color: "w" }, { square: "g6", type: "p", color: "b" }
];
...
function addGameContext(position: PracticePosition, lessonId: string): PracticePosition {
    ...
    for (const candidate of orderedContextPieces(position.id)) {
        ...
        if (!placed || !sameTeachingShape(board, position, initialCheck, originalOutcome)) board.remove(candidate.square);
    }
