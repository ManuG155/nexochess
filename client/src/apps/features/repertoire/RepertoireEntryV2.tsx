...
import ManualSavedLinesDock from "./ManualSavedLinesDock";
import ManualEditorPolish from "./ManualEditorPolish";
...
function RepertoireWorkspace() {
    ...
    if (target && mode == "mine") {
        return <main className={`${hubStyles.page} repertoire-manual-polish`}>
            <ManualEditorPolish/>
            <ManualSavedLinesDock
                store={store}
                setStore={setStore}
                target={target}
                onOpen={setTarget}
